                                                                ...
                                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                    <tbody><tr>
                                                                        <td valign="top" class="textContent">
                                                                            ...
                                                                            -->
                                                                            <h3 mc:edit="header" style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;">Buna!</h3>
                                                                            <div mc:edit="body" style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">Ne bucuram sa te anuntam ca esti castigatorul concursului de saptamana aceasta. Te rugam sa ne confirmi primirea mail-ului prin adresa de livrare a premiului tau. In caz contrar nu vei putea intra in posesia acestuia. <br><p>Iti multumim pentru paritcipare. </p>
                                                                                <p>Cu drag echipa ITimerBook.</p></div>
                                                                        </td>
                                                                    </tr>
                                                                    </tbody></table>
                                                                <!-- // CONTENT TABLE -->
